...
function Users() {
  ...
  useEffect(() => {
    const handleOutsideClick = (event) => {
      if (
        (popupRef.current && !popupRef.current.contains(event.target) && isPopupOpen) ||
        (editPopupRef.current && !editPopupRef.current.contains(event.target) && isEditPopupOpen)
      ) {
        setPopupOpen(false);
        ...
        <div className="user-container">
          ...
          <div className="product-container">
            ...
            <div className="specific-user">
              ...
              <div className="edit-container">
                <button className="user-edit-buttons" onClick={handleEditButtonClick}>
          ...
          <div className="user-buttons">
            <div className="product-creating-stuff">
              <button className="user-create-buttons" onClick={handleButtonClick}>
            ...
            <div className="product-page-swappers">
                ...
                <div className="popup-box" ref={popupRef}>
                  ...
                  <div className="popup-layout">
                    ...
                    <div className="popup-input">
                      ...
                      <select name="role" className="popup-dropdown" >
                        {roles.map((role) => (
              ...
              <div className="popup-overlay">
                <div className="popup-box" ref={editPopupRef}>
                    ...
                    <div className="popup-input">
                      <div className="input-row">
                        ...
                        {errorMessages.EditUsername && (
                          <p className="error-text">{errorMessages.EditUsername}</p>
                        )}
                      </div>
                      <input
                        type="text"
                    ...
                    <div className="popup-input">
                      <div className="input-row">
                        ...
                        {errorMessages.EditPassword && (
                          <p className="error-text">{errorMessages.EditPassword}</p>
                        )}
                      </div>
                      <input type="text" />
                    </div>
                    <div className="popup-input">
                      <div className="input-row">
                        ...
                        {errorMessages.EditEmail && (
                          <p className="error-text">{errorMessages.EditEmail}</p>
                        )}
                      </div>
                      <input
                        type="email"
                    ...
                    <div className="popup-input">
                      <div className="input-row">
                        ...
                        {errorMessages.EditRole && (
                          <p className="error-text">{errorMessages.EditRole}</p>
                        )}
                      </div>
                  ...
                  <div className="left">
                    ...
                    <button className="popup-button">
                      <h1 className="button-text">Remove user</h1>
                    </button>
                  </div>
                </div>
              </div>
